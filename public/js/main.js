...
(function ($) {
    ...
    function makeTimer() {
        ...
        $("#days").html(days + "<span class='text-white'>Days</span>");
        $("#hours").html(hours + "<span class='text-white'>Hours</span>");
        $("#minutes").html(minutes + "<span class='text-white'>Minutes</span>");
        $("#seconds").html(seconds + "<span class='text-white'>Seconds</span>");
    }
